  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <select
          className="px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-pink-600 dark:bg-gray-700 dark:text-white"
          value={timeRange}
      ...
      <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="p-6 bg-white rounded-lg shadow dark:bg-gray-800">
          <div className="flex justify-between items-center mb-4">
            <div className="p-3 bg-pink-600 rounded-full dark:bg-pink-600">
              <FiTrendingUp className="w-6 h-6 text-pink-600 dark:text-pink-600" />
            </div>
          ...
          <div className="mt-4">
            <BarChart data={mockData.products.chart} color="bg-pink-600" />
          </div>
        </div>
      </div>
