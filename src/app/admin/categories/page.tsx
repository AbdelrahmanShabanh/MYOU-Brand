...
export default function AdminCategoriesPage() {
  ...
  // Ù…Ø¹Ø§ÙŠÙ†Ø© Ø§Ù„ØµÙˆØ±Ø© Ø§Ù„Ù…Ø®ØªØ§Ø±Ø© Ù„Ù„ÙØ¦Ø§Øª
  ...
  // Ù…Ø¹Ø§ÙŠÙ†Ø© Ø§Ù„ØµÙˆØ±Ø© Ø§Ù„Ù…Ø®ØªØ§Ø±Ø© Ù„Ù„Ø³Ù„Ø§ÙŠØ¯Ø±
  ...
  // Ù…Ø¹Ø§ÙŠÙ†Ø© Ø§Ù„ØµÙˆØ±Ø© Ø§Ù„Ù…Ø®ØªØ§Ø±Ø© Ù„ØªØ­Ø±ÙŠØ± Ø§Ù„ÙØ¦Ø©
  ...
  // Ù…Ø¹Ø§ÙŠÙ†Ø© Ø§Ù„ØµÙˆØ±Ø© Ø§Ù„Ù…Ø®ØªØ§Ø±Ø© Ù„ØªØ­Ø±ÙŠØ± Ø§Ù„Ø³Ù„Ø§ÙŠØ¯Ø±
  ...
  async function handleAddCategory(e: React.FormEvent) {
    e.preventDefault();
    if (!newCategory.trim() || !imagePreview) return;
    ...
    try {
      const payload = {
        ...
        image: imagePreview, // which is base64 string
      };
  ...
  async function handleEditCategory(e: React.FormEvent) {
    ...
    try {
      ...
      if (editCategoryImagePreview && editCategoryImagePreview.startsWith("data:image")) {
        payload.image = editCategoryImagePreview;
      }
  ...
  async function handleEditHeroSlide(e: React.FormEvent) {
    ...
    try {
      const payload: any = {
        title: editSlideData.title.trim(),
        subtitle: editSlideData.subtitle.trim(),
      };
      if (editSlideImagePreview && editSlideImagePreview.startsWith("data:image")) {
        payload.image = editSlideImagePreview;
      }
      ...
      {activeTab === "categories" && (
        <div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-md border focus:outline-none focus:ring-2 focus:ring-pink-600"
                  required
                />
              </div>
            ...
            <button
              type="submit"
              className="px-6 py-2 text-white bg-pink-600 rounded-md hover:bg-pink-600 disabled:opacity-50"
              disabled={loading || !newCategory.trim() || !imagePreview}
            >
          ...
          <div className="bg-white p-6 rounded-lg max-w-md w-full mx-4">
            ...
            <form onSubmit={handleEditCategory}>
              ...
              <div className="flex space-x-3">
                <button
                  type="submit"
                  className="px-4 py-2 text-white bg-pink-600 rounded-md hover:bg-pink-600 disabled:opacity-50"
