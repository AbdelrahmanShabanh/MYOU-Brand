      ...
      <div className="p-6 bg-white rounded-lg shadow dark:bg-gray-800">
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-pink-600 dark:bg-gray-700 dark:text-white ${
                  errors.name
                    ? "border-red-500"
                      ...
                      {[
                        ...
                        >
                          <input
                            ...
                            className="text-pink-600 rounded border-gray-300 focus:ring-pink-600"
                          />
                          ...
                          {formData.sizes.map((size) => (
                            <div key={size} className="space-y-1">
                              ...
                              <input
                                ...
                                className="px-3 py-2 w-full text-sm rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-600 dark:bg-gray-700 dark:text-white dark:border-gray-600"
                                placeholder="0"
                              />
                            </div>
                          ))}
            ...
            <div>
              ...
              <input
                ...
                min="0"
                max="100"
                className="px-4 py-2 w-full rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-600 dark:bg-gray-700 dark:text-white dark:border-gray-600"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Leave empty to use a placeholder image. Images will be stored directly in the database.
              </p>
            </div>
          ...
          <div className="flex justify-end mt-6">
            <button
              type="submit"
              className="flex items-center px-4 py-2 text-white bg-pink-600 rounded-md hover:bg-pink-600"
            >
