      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="flex items-center px-4 py-2 text-white bg-pink-600 rounded-lg transition-colors hover:bg-pink-600"
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="px-3 py-2 w-full rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-600"
                    required
                  />
                </div>
                ...
                <div className="flex space-x-3">
                  <button
                    type="submit"
                    className="flex-1 px-4 py-2 text-white bg-pink-600 rounded-md transition-colors hover:bg-pink-600"
                  >
