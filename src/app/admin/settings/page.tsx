    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button 
          ...
          className="bg-pink-600 hover:bg-pink-600 text-white px-4 py-2 rounded-md flex items-center"
        >
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center mb-4">
            <FiBell className="h-6 w-6 text-pink-600 dark:text-pink-600 mr-2" />
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                ...
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-pink-600 dark:peer-focus:ring-pink-600 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-pink-600"></div>
              </label>
            </div>
            <div className="flex items-center justify-between">
              <div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center mb-4">
            <FiLock className="h-6 w-6 text-pink-600 dark:text-pink-600 mr-2" />
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                id="sessionTimeout"
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-600 dark:bg-gray-700 dark:text-white"
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center mb-4">
            <FiGlobe className="h-6 w-6 text-pink-600 dark:text-pink-600 mr-2" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center mb-4">
            <FiCreditCard className="h-6 w-6 text-pink-600 dark:text-pink-600 mr-2" />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center mb-4">
            <FiMail className="h-6 w-6 text-pink-600 dark:text-pink-600 mr-2" />
