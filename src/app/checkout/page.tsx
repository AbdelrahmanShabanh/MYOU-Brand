...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "+201070831335";
      const orderId = orderData._id || 'Pending';
      const shortOrderId = orderId !== 'Pending' ? orderId.substring(orderId.length - 6).toUpperCase() : 'Pending';
      
      const message = `Hello MYOU!\n\nI just placed an order on your website.\n\n*Order Details:*\nOrder ID: #${shortOrderId}\nName: ${firstName} ${lastName}\nPhone: ${phone}\nTotal Amount: LE ${total.toFixed(2)}\n\nPlease confirm my order. Thank you!`;
        ...
        >
          ...
          >
            ...
            <div className="flex relative justify-center items-center mx-auto mb-4 w-16 h-16 bg-green-100 rounded-full animate-pulse-slow">
              ...
              <div className="absolute -top-2 -right-2 w-4 h-4 bg-pink-600 rounded-full animate-bounce"></div>
              <div
            ...
            <div className="flex flex-col space-y-3">
              <button
                onClick={() => setShowSuccess(false)}
                className="px-4 py-2 w-full font-medium text-white bg-pink-600 rounded-md transition-colors hover:bg-pink-600"
              >
                OK
              </button>
        ...
        <div className="px-4 py-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              <Link
                href="/"
                className="text-2xl font-bold text-pink-600 dark:text-pink-600"
              >
                <Image
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    ...
                    <input
                      ...
                      required
                      className={`pl-10 block w-full rounded-md shadow-sm focus:ring-pink-600 focus:border-pink-600 dark:bg-gray-700 dark:text-white sm:text-sm ${
                        errors.email
                  ...
                  <div className="relative mt-1">
                    ...
                    <div className="flex">
                      ...
                      <input
                        ...
                        required
                        className={`flex-1 block w-full rounded-r-md shadow-sm focus:ring-pink-600 focus:border-pink-600 dark:bg-gray-700 dark:text-white sm:text-sm ${
                          errors.phone
                            ? "border-red-300 dark:border-red-600"
                            : "border-gray-300 dark:border-gray-600"
                        }`}
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                  ...
                  <select
                    ...
                    className="block mt-1 w-full rounded-md border-gray-300 shadow-sm dark:border-gray-600 focus:border-pink-600 focus:ring-pink-600 dark:bg-gray-700 dark:text-white sm:text-sm"
                  >
                    <option>Egypt</option>
                    <option>UAE</option>
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className={`mt-1 block w-full rounded-md shadow-sm focus:border-pink-600 focus:ring-pink-600 dark:bg-gray-700 dark:text-white sm:text-sm ${
                      errors.firstName
                        ? "border-red-300 dark:border-red-600"
                        : "border-gray-300 dark:border-gray-600"
                    }`}
            ...
            {/* <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
              ...
              <div className="space-y-2">
                <label className="flex items-center px-4 py-3 rounded-md border transition-all duration-150 cursor-pointer focus-within:ring-2 focus-within:ring-pink-600">
                  <input
                    type="radio"
                    name="shipping"
                    value="express"
            ...
            <div className="flex items-start">
              <input
                ...
                className="w-4 h-4 text-pink-600 rounded border-gray-300 focus:ring-pink-600"
              />
              <label
                htmlFor="terms"
            ...
            <div className="p-4 bg-green-50 rounded-lg dark:bg-green-900/20 mb-2 border border-green-200">
              ...
              <p className="text-sm text-green-700 dark:text-green-400 mt-1">
                After placing your order, you will be redirected to WhatsApp to send us a confirmation message. <strong>Your order will not be processed until confirmed via WhatsApp.</strong>
              </p>
            </div>
            <button
              type="submit"
              disabled={isSubmitting}
              className={`flex justify-center items-center px-4 py-3 space-x-2 w-full font-medium text-white rounded-full focus:outline-none focus:ring-2 focus:ring-pink-600 focus:ring-offset-2 ${
                isSubmitting
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg lg:sticky lg:top-8">
            ...
            <form onSubmit={handleApplyCoupon} className="flex mb-4">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-l-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-600"
              />
              <button
                type="submit"
            ...
            <div className="pt-4 space-y-2 border-t border-gray-200">
              ...
              <div className="flex justify-between pt-2 text-base font-medium border-t border-gray-200 dark:border-gray-700">
                ...
                <span className="text-xl font-bold text-pink-600 dark:text-pink-600">
                  LE {total.toFixed(2)}
                </span>
              </div>
            </div>
