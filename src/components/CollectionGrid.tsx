  ...
  return (
    ...
    >
      ...
      <div className="mb-16">
        ...
        {!topSellersLoading && !topSellersError && topSellers.length > 0 && (
          <div className="flex overflow-x-auto gap-6 pb-6 mb-10 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            {topSellers
              .filter(
                (topSeller) =>
                  topSeller &&
              ...
              .map((topSeller, index) => (
                <Link
                  ...
                  className="flex-none w-[220px] sm:w-[260px] md:w-[280px] snap-start group relative overflow-hidden rounded-lg shadow-md hover:shadow-xl 
                         transition-all duration-300 aspect-[4/5] bg-white block"
                >
                  {/* Badge for ranking */}
