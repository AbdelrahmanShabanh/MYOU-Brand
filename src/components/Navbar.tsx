...
const Navbar = () => {
  ...
  // Ø¥Ù†Ø´Ø§Ø¡ Ø±ÙˆØ§Ø¨Ø· Ø§Ù„ØªÙ†Ù‚Ù„ Ù…Ù† Ø§Ù„ÙØ¦Ø§Øª Ø§Ù„Ø¯ÙŠÙ†Ø§Ù…ÙŠÙƒÙŠØ©
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="absolute left-0 right-0 top-16 overflow-hidden bg-white border-b border-gray-200 shadow-md md:hidden"
            >
              <div className="py-2">
                {loading ? (
                ...
                <Link
                  href="/track-order"
                  className="block flex items-center px-4 py-2 text-sm font-medium text-gray-600 hover:text-pink-600 dark:text-gray-300 dark:hover:text-pink-600"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
